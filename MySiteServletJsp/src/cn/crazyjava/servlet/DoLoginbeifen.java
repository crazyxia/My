 ...
 * 实现网站页面登录的功能Servlet
 */
@WebServlet("/dologin(beifen)")
public class DoLoginbeifen extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DoLoginbeifen() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String name = new String(newinfo.getBytes("iso8859_1"), "UTF-8");// 网页中文乱码处理方式
